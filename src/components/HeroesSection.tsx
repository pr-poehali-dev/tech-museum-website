...
const HeroesSection = () => {
  const heroes = [
    ...
    },
    {
      ...
      years: "1992 - 2024",
      specialty: "Оператор станков с ЧПУ",
      graduation: "2012",
      photo:
        "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=300&h=300&fit=crop&crop=face",
      biography:
        "Выпускник 2012 года. Младший сержант разведки. Награжден медалью 'За отвагу' посмертно.",
    },
    {
      id: 5,
      ...
      biography:
        "Выпускник 2007 года. Сапёр инженерных войск. Погиб при разминировании объекта, спасая мирных жителей.",
    },
  ];
